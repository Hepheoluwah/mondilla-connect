...
export function TestimonialsSection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-pink-50 dark:from-gray-900 dark:to-purple-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="p-8 rounded-2xl border border-white/40 dark:border-gray-700 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 shadow-md hover:shadow-xl transition-all duration-300"
            >
        ...
        <div className="md:hidden">
          <motion.div
            ...
            className="p-8 rounded-2xl border border-white/40 dark:border-gray-700 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 shadow-md"
          >
            <div className="space-y-6">
              <div className="flex space-x-1">
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-16 border-t border-white/40 dark:border-gray-700"
        >
