...
export function HeroSection() {
  return (
    <section className="min-h-screen pt-16 bg-gradient-subtle relative overflow-hidden">
          ...
          >
            <div className="relative">
              <img
                ...
                className="w-full h-auto rounded-2xl shadow-card-hover animate-float"
              />
            ...
            <motion.div
              ...
              className="absolute -top-8 -left-8 glass rounded-xl p-4 shadow-card"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-8 -right-8 glass rounded-xl p-4 shadow-card"
            >
